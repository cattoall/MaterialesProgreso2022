    ...
    Private Sub get_selected_customer()
        ...
        If MetroGrid1.RowCount > 0 Then
            ...
            Select Case Buscar_Clientes
                Case "VENTAS"
                    FrmPuntoDeVenta.txtCliente.Text = MetroGrid1.Item(1, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(2, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value
                    FrmPuntoDeVenta.txtDomicilio.Text = MetroGrid1.Item(4, MetroGrid1.CurrentRow.Index).Value & " # " &
                                                        MetroGrid1.Item(5, MetroGrid1.CurrentRow.Index).Value & " Colonia " &
                                                        MetroGrid1.Item(6, MetroGrid1.CurrentRow.Index).Value & " Ciudad " &
                                                        MetroGrid1.Item(7, MetroGrid1.CurrentRow.Index).Value & " Estado " &
                                                        MetroGrid1.Item(8, MetroGrid1.CurrentRow.Index).Value & " Código Postal " &
                                                        MetroGrid1.Item(9, MetroGrid1.CurrentRow.Index).Value & " R.F.C. " &
                                                        MetroGrid1.Item(10, MetroGrid1.CurrentRow.Index).Value
                    Cliente_diasCredito = MetroGrid1.Item(16, MetroGrid1.CurrentRow.Index).Value
                    Cliente_limite = MetroGrid1.Item(17, MetroGrid1.CurrentRow.Index).Value
                    FrmPuntoDeVenta.txtIdCliente.Text = MetroGrid1.Item(0, MetroGrid1.CurrentRow.Index).Value
                Case "PAGOS"
                    FrmCuentasPorCobrar.TxtCliente.Text = MetroGrid1.Item(1, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(2, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value
                    FrmCuentasPorCobrar.TxtDomicilio.Text = MetroGrid1.Item(4, MetroGrid1.CurrentRow.Index).Value & " # " &
                                                        MetroGrid1.Item(5, MetroGrid1.CurrentRow.Index).Value & " Colonia " &
                                                        MetroGrid1.Item(6, MetroGrid1.CurrentRow.Index).Value & " Ciudad " &
                                                        MetroGrid1.Item(7, MetroGrid1.CurrentRow.Index).Value & " Estado " &
                                                        MetroGrid1.Item(8, MetroGrid1.CurrentRow.Index).Value & " Código Postal " &
                                                        ...
                                                        MetroGrid1.Item(10, MetroGrid1.CurrentRow.Index).Value
                Case "HISTORIAL"
                    FrmHistorialCliente.txtCliente.Text = MetroGrid1.Item(1, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(2, MetroGrid1.CurrentRow.Index).Value & " " & MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value
