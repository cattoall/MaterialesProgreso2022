Public Class frmCuentasPorCobrarWendy
    ...
    Private Sub llenar_datagrid()
        ...
        Dim tCobrar As List(Of tblWCobrar) = DBModelo.GetCXC_ByIdClienteWendy(CInt(idClienteVenta))
        ...
        Dim tHistPagos As List(Of tblWHistorialPagos) = DBModelo.GetHistorialPago_ByIdClienteWendy(CInt(idClienteVenta))
    ...
    Private Sub CancelarAbono()
        ...
        Dim w_cobrar As tblWCobrar = DBModelo.Get_CobrarTipoDocWendy(CInt(lv_remision), lv_TipoDoc, Idcliente)
