...
Public Class FrmBuscarProductosINV
    ...
    Private Sub get_selected_product()
        If MetroGrid1.RowCount > 0 Then
            Add_Update = True
            If MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value <> "" Then
                FrmAjusteDeInventario.txtDescripcion.Text = MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value
            ...
            End If
            ProductoID = MetroGrid1.Item(0, MetroGrid1.CurrentRow.Index).Value
            If MetroGrid1.Item(20, MetroGrid1.CurrentRow.Index).Value = False Then
                Inventariado = False
            Else
                Inventariado = True
            End If
