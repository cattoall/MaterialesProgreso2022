...
Public Class FrmListaProductos
    ...
    Private Sub ConfiguraGrid()
        ...
        DataGridView1.Columns(2).HeaderText = "Cod.Barras"
        ...
        DataGridView1.Columns(4).HeaderText = "Descripción del Producto"
        ...
        DataGridView1.Columns(16).HeaderText = "Público"
        ...
        DataGridView1.Columns(20).HeaderText = "Stock"
        ...
        DataGridView1.Columns(20).HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter
        DataGridView1.Columns(20).DefaultCellStyle.Format = "########0.00"
