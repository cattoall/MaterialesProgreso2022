Public Class FrmBuscarClientes
    ...
    Private Sub MetroGrid1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles MetroGrid1.CellDoubleClick
        If MetroGrid1.RowCount > 0 Then
            ...
            FrmClientes.lv_idCliente = MetroGrid1.Item(0, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtNombre.Text = MetroGrid1.Item(1, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtApat.Text = MetroGrid1.Item(2, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtAmat.Text = MetroGrid1.Item(3, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtDomicilio.Text = MetroGrid1.Item(4, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtNumExterno.Text = MetroGrid1.Item(5, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtColonia.Text = MetroGrid1.Item(6, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtCiudad.Text = MetroGrid1.Item(7, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtEstado.Text = MetroGrid1.Item(8, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtCodigoPostal.Text = MetroGrid1.Item(9, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtRFC.Text = MetroGrid1.Item(10, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtTelFijo.Text = MetroGrid1.Item(11, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtMovil.Text = MetroGrid1.Item(12, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtEmail.Text = MetroGrid1.Item(13, MetroGrid1.CurrentRow.Index).Value
            FrmClientes.txtObs.Text = MetroGrid1.Item(14, MetroGrid1.CurrentRow.Index).Value
            Select Case MetroGrid1.Item(15, MetroGrid1.CurrentRow.Index).Value
                Case "Precio Publico"
            ...
            End Select
            FrmClientes.txtCredito.Text = CInt(MetroGrid1.Item(16, MetroGrid1.CurrentRow.Index).Value)
            FrmClientes.txtLimite.Text = CDbl(MetroGrid1.Item(17, MetroGrid1.CurrentRow.Index).Value)

            If MetroGrid1.Item(18, MetroGrid1.CurrentRow.Index).Value <> "" Then
                FrmClientes.CmbTipo.SelectedIndex = FrmClientes.CmbTipo.FindString(MetroGrid1.Item(18, MetroGrid1.CurrentRow.Index).Value)
            Else
                FrmClientes.CmbTipo.SelectedIndex = -1
            End If

            If Not IsDBNull(MetroGrid1.Item(19, MetroGrid1.CurrentRow.Index).Value) Then
                If MetroGrid1.Item(19, MetroGrid1.CurrentRow.Index).Value <> "" Then
                    FrmClientes.cmbMetodoPago.SelectedIndex = FrmClientes.cmbMetodoPago.FindString(MetroGrid1.Item(19, MetroGrid1.CurrentRow.Index).Value)
                Else
            ...
            If MetroGrid1.Item(20, MetroGrid1.CurrentRow.Index).Value <> "" Then
                FrmClientes.CmbCredito.SelectedIndex = FrmClientes.CmbCredito.FindString(MetroGrid1.Item(20, MetroGrid1.CurrentRow.Index).Value)
            Else
                FrmClientes.CmbCredito.SelectedIndex = -1
            End If

            If MetroGrid1.Item(21, MetroGrid1.CurrentRow.Index).Value <> "" Then
                FrmClientes.txtCuenta.Text = MetroGrid1.Item(21, MetroGrid1.CurrentRow.Index).Value
            Else
                FrmClientes.txtCuenta.Clear()
            End If

            If MetroGrid1.Item(22, MetroGrid1.CurrentRow.Index).Value <> "" Then
                FrmClientes.CmbBanco.SelectedIndex = FrmClientes.CmbBanco.FindString(MetroGrid1.Item(22, MetroGrid1.CurrentRow.Index).Value)
            Else
            ...
            End If
            If Not IsDBNull(MetroGrid1.Item(24, MetroGrid1.CurrentRow.Index).Value) Then
                If MetroGrid1.Item(24, MetroGrid1.CurrentRow.Index).Value <> "" Then
                    FrmClientes.cmbFormaPago.SelectedIndex = FrmClientes.cmbFormaPago.FindString(MetroGrid1.Item(24, MetroGrid1.CurrentRow.Index).Value)
                Else
