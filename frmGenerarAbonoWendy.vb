Public Class frmGenerarAbonoWendy
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        ElseIf txttotal.Text < 0 Then
            ...
            Exit Sub
        End If
        If CInt(txttotal.Text) > CInt(lblresto.Text) Then
        ...
        If DBModelo.InsertHistorialPagoWendy(w_HistPago) Then
            actualiza()
            ...
            tipodoc = ""
            If ImprimeTicketAbonoWendy(cuenta, True, abono) = False Then
    ...
    Private Sub frmGenerarAbonoWendy_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtventa.Text = venta
    ...
    Private Sub RbnTotal_CheckedChanged(sender As Object, e As EventArgs) Handles RbnTotal.CheckedChanged
    ...
    Private Sub RbnParcial_CheckedChanged(sender As Object, e As EventArgs) Handles RbnParcial.CheckedChanged
